...
//            check which type of notification are checked
...
//            check if all input of form are correct
...
//            add receiver to db
            ...
            if(id != -1) {
                ...
                Toast.makeText(CreateReceiveActivity.this, "Receiver creation successfully", Toast.LENGTH_SHORT).show();
